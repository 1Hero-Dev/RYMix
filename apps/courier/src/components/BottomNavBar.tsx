...
import { Map, ListTodo, CircleDollarSign, User } from 'lucide-react';
...
export const BottomNavBar: React.FC = () => {
  ...
  const tabs = [
    { id: '/', label: 'Carte & Courses', icon: Map, badge: 1 },
    { id: '/pool', label: 'Commandes', icon: ListTodo },
    { id: '/earnings', label: 'Revenus', icon: CircleDollarSign },
    { id: '/profile', label: 'Statut', icon: User },
  ];
